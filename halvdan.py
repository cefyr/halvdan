...
#    scr = curses.newwin(h - 1, w, 0, 0) #might have to be a pad?
    pad = textpad.Textbox(stdscr, insert_mode = True)
    pad.stripspaces = False
    ...
    # Helpful regexes and list comprehendings should be kept an eye on
    # so I don't forget how they work here
    lines = re.split(r'(\n)', text)
    ...
    editface = pad.edit()
    stdscr.addstr(1,1,editface.encode('utf_8')) 
    stdscr.refresh()
